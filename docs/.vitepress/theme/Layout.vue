...
const McBeeRef = ref<HTMLImageElement | null>(null);
...
const McBeeDisable = ref<(() => void) | null>(null);
...
onUnmounted(() => {
  McBeeDisable.value && McBeeDisable.value();
});
</script>
